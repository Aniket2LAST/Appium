...
public class LoginAlchemy extends BaseClass{
	
public LoginAlchemy(WebDriver alcDriver) {
		
		PageFactory.initElements(alcDriver, this);
		}

@FindBy(xpath="//input[@placeholder='Email address / Phone']")
...
public void twoFactorAuth() throws InterruptedException {
	...
	six.sendKeys("9");
	  ...
	  branches_TAB))); branches_TAB.isDisplayed();
